...
import { ArrowLeft, Users, Bell, Calendar } from 'lucide-react';
...
export default function FeedPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="bg-rich-charcoal border-b border-light-charcoal sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            <Button
              variant="ghost"
              onClick={() => navigate(-1)}
              className="hover:bg-medium-charcoal rounded-organic-sm"
            >
              <ArrowLeft className="h-4 w-4 mr-2" />
              Back
            </Button>
            <div className="flex-1">
              <h1 className="text-2xl font-semibold text-pure-white flex items-center gap-2">
                <Users className="h-6 w-6 text-emerald" />
                Your Feed
              </h1>
              <p className="text-sm text-soft-gray">
                Latest recipes from bartenders you follow
              </p>
            </div>
          </div>
        </div>
