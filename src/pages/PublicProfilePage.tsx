                  ...
                  <div className="md:gap-6 gap-4 flex items-center justify-start">
                    ...
                    <div className="flex-1 min-w-0 flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2 text-sm text-soft-gray">
                        ...
                        <button onClick={() => navigate(`/profile/${username}/followers`)} className="flex items-center gap-1.5 p-0 m-0 min-h-0 hover:text-pure-white transition-colors bg-transparent border-none text-left text-inherit font-inherit text-sm">
