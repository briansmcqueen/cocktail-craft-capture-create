          ...
          <div className="max-w-6xl mx-auto px-4 py-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                />
                {recipe.photo_credit && (
                  <div className="gap-1 mt-2 mb-4 flex items-start justify-end md:justify-start">
                    ...
                    {recipe.photo_credit.url ? (
                      <a
                        ...
                        className="text-xs text-muted-foreground italic hover:text-primary transition-colors"
                      >
                        {recipe.photo_credit.name}
                      </a>
                    ) : (
                      <span className="text-xs text-muted-foreground italic">{recipe.photo_credit.name}</span>
                    )}
                  </div>
                )}
